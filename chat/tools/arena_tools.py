...
EDIT_BOOKING_TOOL = {
    ...
    "function": {
        ...
        "description": (
            ...
            # --- Қазақша ---
            "Бар расталған немесе төлем күтіп тұрған брондаудың деректерін өзгерту. "
            "Пайдаланушы уақытты/күнді АУЫСТЫРҒЫСЫ, алаңды АУЫСТЫРҒЫСЫ, ойыншылар санын "
            "немесе өз атын өзгерткісі келгенде осы функцияны ШАҚЫР "
            "(мысалы: «жұмаға 18:00-ге ауыстырыңыз», «басқа алаңға ауыстырайық», "
            "«10 адам боламыз», «атын Алматқа өзгертіңіз»). "
            "ТЕК пайдаланушы шынымен өзгерткен параметрлерді толтыр — "
            "қалғандарын бос қалдыр, бэкенд ағымдағы брондаудан мәндерді алады. "
            "Егер ешқандай дерек болмаса (мысалы, жаңа күнсіз «брондауымды ауыстырыңыз»), "
            "бәрібір функцияны бос параметрлермен шақыр — бот деректерді өзі сұрайды. "
            "Өңдеуге бола ма екенін өзің тексеруге тырыспа (48 сағат ережесі және т.б.) — "
            "мұны бэкенд жасап, түсінікті қате қайтарады."
        ),
        "parameters": {
            "type": "object",
            "properties": {
            ...
            "properties": {
                ...
                "time_start": {
                    ...
                    "description": "Время начала, формат HH:MM (24h). "
                                   ...
                                   # --- Қазақша ---
                                   "Басталу уақыты, HH:MM пішімі (24с). "
                                   "Уақыт маркері бар сан («на 10», «в 10», «сағат 10», «10ға») "
                                   "адам туралы сөзсіз — бұл уақыт; system-промпт ережелері бойынша "
                ...
                "players": {
                    ...
                    "description": "Количество игроков. Заполняй ТОЛЬКО при маркере людей "
                                   ...
                                   "Если число превышает 200, верни null.\n\n"
                                   # --- Қазақша ---
                                   "Ойыншылар саны. ТЕК адам маркері болғанда толтыр "
                                   "(«для 10», «10 человек», «нас 10», «10 адам», «10 кісі»). "
                                   "Уақыт маркері бар жалаң сан («на 10») — бұл ойыншылар ЕМЕС, null қайтар. "
                                   "Егер сан 200-ден асса, null қайтар."
                },
                "name": {
                    "type": ["string", "null"],
